...
{
   Camera camera;
   camera.position = {0.0f, 0.f, 10.5f};
   ...
   light.direction = {1.0f, 0.0f, -1.0f};
...

   {
      ...
      RendererPhong renderer(camera, {0.01f, 0.01f, 0.01f});
   ...
   }
   {
      ...
      renderer.renderScene(scene, RESOLUTION, RESOLUTION, "pbr.bmp",1.2f,2.f);
   }
   return 0;
}
