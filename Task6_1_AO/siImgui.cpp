...
void siImgui::bindVariables(float4* cameraPos, float4* cameraTarget, int* targetOutput, float4* lightColor, float4* ambientColor, float* aoPower, float* aoRadius, float* aoBias)
{
   camPos = cameraPos;
